...
extension UIStackView {
	class func setupwWith(topView: UIView, middleView: UIView? = nil, bottomView: UIView, isHorizontal: Bool = true, spacing: CGFloat, addTo view: UIView, alignment: UIStackView.Alignment = .center) {
		...
		let alignmentAxis: NSLayoutConstraint.Axis = isHorizontal ? .horizontal : .vertical
	...
	class func setupStackview(leftView: UIView, rightView: UIView, alignment: NSLayoutConstraint.Axis = .horizontal, portionleft leftToSuperView: CGFloat, portionright rightToSuperView: CGFloat, spacing: CGFloat) -> UIStackView {
